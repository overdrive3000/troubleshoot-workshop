...
function _aws_cdk_aws_s3_CorsRule(p) {
    ...
    if (!visitedObjects.has(p.allowedMethods))
        _aws_cdk_aws_s3_HttpMethods(p.allowedMethods);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_s3_BucketNotificationDestinationConfig(p) {
    ...
    if (!visitedObjects.has(p.dependencies))
        require("@aws-cdk/core/.warnings.jsii.js")._aws_cdk_core_IDependable(p.dependencies);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_s3_LifecycleRule(p) {
    ...
    if (!visitedObjects.has(p.noncurrentVersionTransitions))
        _aws_cdk_aws_s3_NoncurrentVersionTransition(p.noncurrentVersionTransitions);
    if (!visitedObjects.has(p.transitions))
        _aws_cdk_aws_s3_Transition(p.transitions);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_s3_BucketProps(p) {
    ...
    if (!visitedObjects.has(p.cors))
        _aws_cdk_aws_s3_CorsRule(p.cors);
    ...
    if (!visitedObjects.has(p.intelligentTieringConfigurations))
        _aws_cdk_aws_s3_IntelligentTieringConfiguration(p.intelligentTieringConfigurations);
    if (!visitedObjects.has(p.inventories))
        _aws_cdk_aws_s3_Inventory(p.inventories);
    if (!visitedObjects.has(p.lifecycleRules))
        _aws_cdk_aws_s3_LifecycleRule(p.lifecycleRules);
    if (!visitedObjects.has(p.metrics))
        _aws_cdk_aws_s3_BucketMetrics(p.metrics);
    ...
    if (!visitedObjects.has(p.websiteRoutingRules))
        _aws_cdk_aws_s3_RoutingRule(p.websiteRoutingRules);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_s3_CfnBucketProps(p) {
    ...
    if (!visitedObjects.has(p.accelerateConfiguration))
        _aws_cdk_aws_s3_CfnBucket_AccelerateConfigurationProperty(p.accelerateConfiguration);
    if (!visitedObjects.has(p.tags))
        require("@aws-cdk/core/.warnings.jsii.js")._aws_cdk_core_CfnTag(p.tags);
    visitedObjects.delete(p);
}
