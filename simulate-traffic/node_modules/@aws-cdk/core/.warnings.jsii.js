function _aws_cdk_core_ConstructOrder(p) {
}
function _aws_cdk_core_IDependable(p) {
}
...
function _aws_cdk_core_CustomResourceProviderRuntime(p) {
    ...
    if (p === ns.CustomResourceProviderRuntime.NODEJS_12)
        print("@aws-cdk/core.CustomResourceProviderRuntime#NODEJS_12", "Use {@link NODEJS_12_X}");
    visitedObjects.delete(p);
}
...
function _aws_cdk_core_FileAssetLocation(p) {
    ...
    visitedObjects.add(p);
    if ("kmsKeyArn" in p)
        print("@aws-cdk/core.FileAssetLocation#kmsKeyArn", "Since bootstrap bucket v4, the key policy properly allows use of the\nkey via the bucket and no additional parameters have to be granted anymore.");
    if ("s3Url" in p)
...
function _aws_cdk_core_SynthesisOptions(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if ("outdir" in p)
        print("@aws-cdk/core.SynthesisOptions#outdir", "use `app.synth()` or `stage.synth()` instead");
    if ("skipValidation" in p)
        print("@aws-cdk/core.SynthesisOptions#skipValidation", "use `app.synth()` or `stage.synth()` instead");
    if ("validateOnSynthesis" in p)
...
function _aws_cdk_core_ValidationError(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.source))
        _aws_cdk_core_Construct(p.source);
    visitedObjects.delete(p);
}
...
function _aws_cdk_core_DockerRunOptions(p) {
    ...
    if (!visitedObjects.has(p.volumes))
        _aws_cdk_core_DockerVolume(p.volumes);
    visitedObjects.delete(p);
}
...
function _aws_cdk_core_IConstruct(p) {
}
function _aws_cdk_core_ConcreteDependable(p) {
}
...
function _aws_cdk_core_Dependency(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.source))
        _aws_cdk_core_IConstruct(p.source);
    if (!visitedObjects.has(p.target))
        _aws_cdk_core_IConstruct(p.target);
    visitedObjects.delete(p);
}
...
function _aws_cdk_core_CfnRuleProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.assertions))
        _aws_cdk_core_CfnRuleAssertion(p.assertions);
...
function _aws_cdk_core_DependableTrait(p) {
}
...
function _aws_cdk_core_CfnCodeDeployBlueGreenHookProps(p) {
    ...
    if (!visitedObjects.has(p.applications))
        _aws_cdk_core_CfnCodeDeployBlueGreenApplication(p.applications);
...
function _aws_cdk_core_Construct(p) {
}
...
function _aws_cdk_core_ConstructNode(p) {
}
...
module.exports = { print, _aws_cdk_core_ConstructOrder, _aws_cdk_core_IDependable, _aws_cdk_core_CfnTrafficRoutingType, _aws_cdk_core_TagType, _aws_cdk_core_CfnDeletionPolicy, _aws_cdk_core_CfnDynamicReferenceService, _aws_cdk_core_RemovalPolicy, _aws_cdk_core_ArnFormat, _aws_cdk_core_SizeRoundingBehavior, _aws_cdk_core_AssetHashType, _aws_cdk_core_FileAssetPackaging, _aws_cdk_core_BundlingOutput, _aws_cdk_core_DockerVolumeConsistency, _aws_cdk_core_SymlinkFollowMode, _aws_cdk_core_IgnoreMode, _aws_cdk_core_CustomResourceProviderRuntime, _aws_cdk_core_CfnCapabilities, _aws_cdk_core_PhysicalName, _aws_cdk_core_CfnIncludeProps, _aws_cdk_core_CfnJsonProps, _aws_cdk_core_GetContextValueResult, _aws_cdk_core_IAsset, _aws_cdk_core_CfnCustomResourceProps, _aws_cdk_core_IStableAnyProducer, _aws_cdk_core_CfnCodeDeployBlueGreenApplicationTarget, _aws_cdk_core_CfnTrafficRoute, _aws_cdk_core_CfnTag, _aws_cdk_core_ResourceEnvironment, _aws_cdk_core_DockerImageAssetLocation, _aws_cdk_core_CfnModuleVersionProps, _aws_cdk_core_EncodingOptions, _aws_cdk_core_IFragmentConcatenator, _aws_cdk_core_LazyStringValueOptions, _aws_cdk_core_TagManagerOptions, _aws_cdk_core_CfnCodeDeployBlueGreenAdditionalOptions, _aws_cdk_core_CfnResourceAutoScalingCreationPolicy, _aws_cdk_core_ExportValueOptions, _aws_cdk_core_IStableStringProducer, _aws_cdk_core_IStableNumberProducer, _aws_cdk_core_ReverseOptions, _aws_cdk_core_ResolveChangeContextOptions, _aws_cdk_core_CfnAutoScalingReplacingUpdate, _aws_cdk_core_CfnAutoScalingScheduledAction, _aws_cdk_core_TimeConversionOptions, _aws_cdk_core_GetContextKeyResult, _aws_cdk_core_IntrinsicProps, _aws_cdk_core_TreeInspector, _aws_cdk_core_IStableListProducer, _aws_cdk_core_BootstraplessSynthesizerProps, _aws_cdk_core_CfnHookProps, _aws_cdk_core_CfnTrafficRoutingTimeBasedCanary, _aws_cdk_core_CfnTrafficRoutingTimeBasedLinear, _aws_cdk_core_CfnResourceProps, _aws_cdk_core_CfnResourceSignal, _aws_cdk_core_Environment, _aws_cdk_core_LazyListValueOptions, _aws_cdk_core_LazyAnyValueOptions, _aws_cdk_core_CfnCodeDeployLambdaAliasUpdate, _aws_cdk_core_SecretsManagerSecretOptions, _aws_cdk_core_CfnHookDefaultVersionProps, _aws_cdk_core_CfnModuleDefaultVersionProps, _aws_cdk_core_CfnResourceDefaultVersionProps, _aws_cdk_core_CfnWaitConditionProps, _aws_cdk_core_GetContextKeyOptions, _aws_cdk_core_CfnHookTypeConfigProps, _aws_cdk_core_CfnMappingProps, _aws_cdk_core_Aws, _aws_cdk_core_DockerBuildOptions, _aws_cdk_core_CfnMacroProps, _aws_cdk_core_ResourceProps, _aws_cdk_core_StageSynthesisOptions, _aws_cdk_core_FileAssetLocation, _aws_cdk_core_CliCredentialsStackSynthesizerProps, _aws_cdk_core_CfnCodeDeployBlueGreenLifecycleEventHooks, _aws_cdk_core_CfnPublicTypeVersionProps, _aws_cdk_core_TagProps, _aws_cdk_core_ITemplateOptions, _aws_cdk_core_CfnAutoScalingRollingUpdate, _aws_cdk_core_DockerImageAssetSource, _aws_cdk_core_AppProps, _aws_cdk_core_CfnParameterProps, _aws_cdk_core_DefaultStackSynthesizerProps, _aws_cdk_core_SynthesisOptions, _aws_cdk_core_StringConcat, _aws_cdk_core_ICfnRuleConditionExpression, _aws_cdk_core_ICfnConditionExpression, _aws_cdk_core_CfnRefElement, _aws_cdk_core_GetContextValueOptions, _aws_cdk_core_IAspect, _aws_cdk_core_ValidationError, _aws_cdk_core_IPostProcessor, _aws_cdk_core_IStringProducer, _aws_cdk_core_IListProducer, _aws_cdk_core_IAnyProducer, _aws_cdk_core_INumberProducer, _aws_cdk_core_ITaggable, _aws_cdk_core_ITokenMapper, _aws_cdk_core_CfnConditionProps, _aws_cdk_core_CfnRuleAssertion, _aws_cdk_core_CfnDynamicReferenceProps, _aws_cdk_core_StageProps, _aws_cdk_core_IInspectable, _aws_cdk_core_ILocalBundling, _aws_cdk_core_ISynthesisSession, _aws_cdk_core_CfnPublisherProps, _aws_cdk_core_IResolvable, _aws_cdk_core_CfnCodeDeployBlueGreenEcsAttributes, _aws_cdk_core_CfnOutputProps, _aws_cdk_core_ScopedAws, _aws_cdk_core_DockerRunOptions, _aws_cdk_core_AssetStagingProps, _aws_cdk_core_GlobIgnoreStrategy, _aws_cdk_core_DockerIgnoreStrategy, _aws_cdk_core_GitIgnoreStrategy, _aws_cdk_core_FingerprintOptions, _aws_cdk_core_FileFingerprintOptions, _aws_cdk_core_SynthesizeStackArtifactOptions, _aws_cdk_core_IConstruct, _aws_cdk_core_ConcreteDependable, _aws_cdk_core_App, _aws_cdk_core_Annotations, _aws_cdk_core_Names, _aws_cdk_core_FeatureFlags, _aws_cdk_core_ResolveOptions, _aws_cdk_core_Dependency, _aws_cdk_core_CfnCodeDeployBlueGreenApplication, _aws_cdk_core_CfnRuleProps, _aws_cdk_core_CfnTrafficRouting, _aws_cdk_core_CfnCreationPolicy, _aws_cdk_core_CfnResourceVersionProps, _aws_cdk_core_CfnStackProps, _aws_cdk_core_FileAssetSource, _aws_cdk_core_CfnHookVersionProps, _aws_cdk_core_CfnDynamicReference, _aws_cdk_core_StackProps, _aws_cdk_core_FileSystem, _aws_cdk_core_CfnHook, _aws_cdk_core_CfnInclude, _aws_cdk_core_CfnMapping, _aws_cdk_core_CfnElement, _aws_cdk_core_IResolveContext, _aws_cdk_core_ITokenResolver, _aws_cdk_core_CfnTrafficRoutingConfig, _aws_cdk_core_RemovalPolicyOptions, _aws_cdk_core_SizeConversionOptions, _aws_cdk_core_CfnTypeActivationProps, _aws_cdk_core_DockerVolume, _aws_cdk_core_TagManager, _aws_cdk_core_CustomResourceProps, _aws_cdk_core_ValidationResult, _aws_cdk_core_Reference, _aws_cdk_core_Intrinsic, _aws_cdk_core_CustomResourceProviderProps, _aws_cdk_core_CfnOutput, _aws_cdk_core_CfnRule, _aws_cdk_core_IResource, _aws_cdk_core_NestedStack, _aws_cdk_core_CustomResource, _aws_cdk_core_Aspects, _aws_cdk_core_CfnWaitConditionHandle, _aws_cdk_core_Tags, _aws_cdk_core_TokenComparison, _aws_cdk_core_Arn, _aws_cdk_core_DependableTrait, _aws_cdk_core_ContextProvider, _aws_cdk_core_ValidationResults, _aws_cdk_core_CfnUpdatePolicy, _aws_cdk_core_CfnCodeDeployBlueGreenHookProps, _aws_cdk_core_BundlingDockerImage, _aws_cdk_core_Token, _aws_cdk_core_NestedStackProps, _aws_cdk_core_ArnComponents, _aws_cdk_core_DefaultTokenResolver, _aws_cdk_core_CfnParameter, _aws_cdk_core_AssetStaging, _aws_cdk_core_DockerImage, _aws_cdk_core_CfnCustomResource, _aws_cdk_core_CfnHookDefaultVersion, _aws_cdk_core_CfnHookTypeConfig, _aws_cdk_core_CfnMacro, _aws_cdk_core_CfnModuleDefaultVersion, _aws_cdk_core_CfnPublicTypeVersion, _aws_cdk_core_CfnResourceDefaultVersion, _aws_cdk_core_AssetOptions, _aws_cdk_core_IgnoreStrategy, _aws_cdk_core_RemoveTag, _aws_cdk_core_Construct, _aws_cdk_core_CfnCondition, _aws_cdk_core_CfnJson, _aws_cdk_core_CfnModuleVersion, _aws_cdk_core_CfnPublisher, _aws_cdk_core_TokenizedStringFragments, _aws_cdk_core_CfnWaitCondition, _aws_cdk_core_IStackSynthesizer, _aws_cdk_core_BundlingOptions, _aws_cdk_core_CustomResourceProvider, _aws_cdk_core_CfnCodeDeployBlueGreenHook, _aws_cdk_core_CfnStack, _aws_cdk_core_Expiration, _aws_cdk_core_Tokenization, _aws_cdk_core_LegacyStackSynthesizer, _aws_cdk_core_BootstraplessSynthesizer, _aws_cdk_core_Tag, _aws_cdk_core_Stage, _aws_cdk_core_CfnHookVersion, _aws_cdk_core_CfnHookVersion_LoggingConfigProperty, _aws_cdk_core_CfnResourceVersion, _aws_cdk_core_CfnResourceVersion_LoggingConfigProperty, _aws_cdk_core_CfnTypeActivation, _aws_cdk_core_CfnTypeActivation_LoggingConfigProperty, _aws_cdk_core_FileCopyOptions, _aws_cdk_core_CopyOptions, _aws_cdk_core_NestedStackSynthesizer, _aws_cdk_core_CliCredentialsStackSynthesizer, _aws_cdk_core_Resource, _aws_cdk_core_ICfnResourceOptions, _aws_cdk_core_SecretValue, _aws_cdk_core_StackSynthesizer, _aws_cdk_core_CfnResource, _aws_cdk_core_DefaultStackSynthesizer, _aws_cdk_core_Size, _aws_cdk_core_CfnStackSetProps, _aws_cdk_core_Fn, _aws_cdk_core_Duration, _aws_cdk_core_Lazy, _aws_cdk_core_CfnStackSet, _aws_cdk_core_CfnStackSet_ParameterProperty, _aws_cdk_core_CfnStackSet_DeploymentTargetsProperty, _aws_cdk_core_CfnStackSet_OperationPreferencesProperty, _aws_cdk_core_CfnStackSet_AutoDeploymentProperty, _aws_cdk_core_CfnStackSet_StackInstancesProperty, _aws_cdk_core_ConstructNode, _aws_cdk_core_Stack };
