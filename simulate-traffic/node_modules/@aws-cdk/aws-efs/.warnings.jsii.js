...
function _aws_cdk_aws_efs_CfnFileSystemProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.fileSystemTags))
        _aws_cdk_aws_efs_CfnFileSystem_ElasticFileSystemTagProperty(p.fileSystemTags);
    visitedObjects.delete(p);
}
