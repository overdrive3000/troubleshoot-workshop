...
function _aws_cdk_aws_cloudfront_CfnCachePolicyProps(p) {
    ...
    if (!visitedObjects.has(p.cachePolicyConfig))
        _aws_cdk_aws_cloudfront_CfnCachePolicy_CachePolicyConfigProperty(p.cachePolicyConfig);
    visitedObjects.delete(p);
}
